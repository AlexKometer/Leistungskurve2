...
from analyse_power import find_best_effort
import pandas as pd
import numpy as np
...
tab1, tab2, tab3 = st.tabs (["EKG-Data", "Power-Data", "Power curve"])
...
with tab2:
    ...
    if hr_max == 0:
        ...
        "HeartRate"].max ():  # Warn the user if the input is lower than the maximum heartrate from the data
